...
contract MusicNFTMarketplace is ERC721("SPotiFi", "SPOTI"), Ownable {
    string public baseURI = "https://ipfs.filebase.io/ipfs/bafybeibz7qz53yekoslgmmnyxd6a2sozw6chxozfrruukainbtmvjbgk34/";
    ...
    constructor(
        ...
        require(
            ...
            "Deployer must pay royalty fee for each token lsited on the marketplace"
        );
        artist = _artist;
